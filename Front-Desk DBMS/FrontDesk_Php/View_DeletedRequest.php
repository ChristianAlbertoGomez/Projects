...
<body>
    <div style="margin-top: 20px" class="container">
        <h1>VIEW ALL DELETED REQUEST REPORT</h1>
        <!-- styling of the form for bootstrap https://getbootstrap.com/docs/4.5/components/forms/ -->
        <form action="View_MostCommonVisitor.php" method="post">

            <div class="form-group">
                <label>All Deleted Requests Shown Below:<label>
            </div>


        <?php $sql = "SELECT * FROM Deletes";
        ...
        <table class="table" width=50%>
            <thead>
                <td> Date Deleted</td>
                <td> Time Deleted</td>
                <td> Deleted By Staff ID</td>
                <td> Deleted Request ID</td>
            </thead>
            <tbody>
                <?php
